...
class TestInferenceClientModel:
    ...
    def test_structured_generation_with_unsupported_provider(self):
        with pytest.raises(
            ValueError, match="InferenceClientModel only supports structured generation with these providers:"
        ):
